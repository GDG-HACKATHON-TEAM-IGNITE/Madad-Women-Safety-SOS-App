...
const Hero = () => {
  ...
  <div className='w-[80%] ml-0 lg:ml-8 text-xl mt-3 flex flex-col items-center lg:flex-row'> 
    ...
    navigate('/sos')
    scrollTo(0,0);
  }} className='w-full px-6 py-3 border rounded-[10px] border-[#A7C7E7] font-light hover:text-white hover:bg-[#A7C7E7] hover:cursor-pointer mb-10 lg:mb-0'>Quick SOS &nbsp;&nbsp;<i className="ri-arrow-right-line"></i></button> 
  </div>
</div>
