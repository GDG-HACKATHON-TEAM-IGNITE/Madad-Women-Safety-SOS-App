        ...
        >
          <div className="px-4 w-full">
            ...
            <div className="mt-6 flex flex-wrap gap-4 justify-center lg:justify-start text-[14px] lg:text-[16px]">
              <button  onClick={()=>navigate('/setting#two')}  className="flex items-center gap-2 py-3 w-full justify-center bg-gray-300 font-bold rounded-[10px] shadow hover:opacity-70">
                <i className="ri-phone-line"></i>
                Edit Contact
              </button>

              <button onClick={()=>navigate('/safeScore#three')} className="flex items-center gap-2 py-3 w-full justify-center bg-gray-300 font-bold rounded-[10px] shadow hover:opacity-70">
